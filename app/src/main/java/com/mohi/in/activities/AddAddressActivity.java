...
//                        SessionStore.saveUserDetails(AddAddressActivity.this, Common.userPrefName, hash.get(SessionStore.USER_ID), hash.get(SessionStore.USER_TOKEN), hash.get(SessionStore.USER_EMAIL)
