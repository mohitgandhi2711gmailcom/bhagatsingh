...
public class TrendingNowAdapter extends RecyclerView.Adapter<TrendingNowAdapter.MyViewHolder> {
    ...
    public TrendingNowAdapter(Context context, ArrayList<BannerModel> list) {
        mList = new ArrayList<>();
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.trending_now_item, parent, false);
