...
public class MostSearchedAdapter extends RecyclerView.Adapter<MostSearchedAdapter.MyViewHolder> {
    private Context mContext;
    private List<BannerModel> mList;

    public MostSearchedAdapter(Context context, List<BannerModel> list) {
        mList = new ArrayList<>();
