...
public class MostSearchedAdapter extends RecyclerView.Adapter<MostSearchedAdapter.ViewHolder> {
    private Context mContext;
    private ArrayList<BannerModel> mList;

    public MostSearchedAdapter(Context context, ArrayList<BannerModel> list) {
        mList = new ArrayList<>();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.most_searched_item, parent, false);
